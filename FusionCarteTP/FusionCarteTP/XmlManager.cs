...
namespace CarteTPService
{
    class XmlManager
    {
        ...
        public static void GenerateXml(string file)
        {
            Pdf = file;
            GetData4Xml();
        }
        ...
        public static void CreateXml(SqlDataReader data)
        {
            try
            {
                ...
                string filename = $"{flow}_{data["type_tiers"]}_{Path.GetFileName(Pdf)}.xml";
